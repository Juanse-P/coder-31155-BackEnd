...
class Contenedor {
    constructor(archivo) {
        ...
        this.objects = this.readData(this.archivo) || [];
    }
    //Genera ID
    async generateId() {
        try {
    ...
    async save(obj) {
        try {
            ...
            console.log(err);
            console.log("Algo salio mal en | Save |");
        }
    }
    async getById(id) {
        try {
            ...
            console.log(err);
            console.log("Algo salio mal en | getBy Id |");
        }
    }
    async getAll() {
        try {
            ...
            console.log(err);
            console.log("Algo salio mal en | getAll |");
        }
    }
    async deleteById(id) {
        try {
            ...
            console.log(err);
            console.log("Algo salio mal en | deleteById |");
        }
    }
    async deleteAll() {
        try {
            ...
            console.log(err);
            console.log("Algo salio mal en | deleteAll |");
        }
    }
    readData(path) {
